...
export function RoomComponent() {
  ...
  return (
    <LiveKitRoom
      ...
      audio={true}
      video={true}
      className="flex flex-col md:grid md:grid-cols-[1fr_360px] lg:grid-cols-[300px_1fr_300px] xl:grid-cols-[360px_1fr_360px] flex-grow overflow-hidden border-0 border-r border-b rounded-b-md"
